    ...
    def build_api_kwargs_extras(
        ...
        if isinstance(reasoning_config, dict):
            ...
            if effort in {"xhigh", "max"}:
                ...
                # No explicit effort → pin to "low" for orchestrator reliability.
                # The deepseek-v4-flash server default of "high" produces
                # long thinking chains that overwhelm the tool catalog and
                # break tool-calling. "low" keeps the model responsive.
