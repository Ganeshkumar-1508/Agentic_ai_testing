...
# Original: reference/deer-flow/backend/app/channels/base.py
...
from harness.channels.commands import extract_connect_code
from harness.channels.message_bus import InboundMessage, InboundMessageType, MessageBus, OutboundMessage, ResolvedAttachment
