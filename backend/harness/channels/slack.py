# Ported from DeerFlow (MIT License, Copyright Bytedance Ltd.)
# Original: reference/deer-flow/backend/app/channels/slack.py
...
from harness.channels.commands import is_known_channel_command
from harness.channels.message_bus import InboundMessageType, MessageBus, OutboundMessage, ResolvedAttachment
