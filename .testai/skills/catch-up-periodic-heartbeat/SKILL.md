...
metadata:
  testai:
    ...
    source_file: "docs\claude-code-system-prompts\system-prompts\skill-catch-up-periodic-heartbeat.md"
    variables: []
---
...
- **Who are they?** read_file `CLAUDE.md` — job, focus areas, the handles that identify them in connected tools.
- **What are you tracking?** read_file `.claude/catch-up-state.json`:
