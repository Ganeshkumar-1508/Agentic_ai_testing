...
metadata:
  testai:
    ...
    source_file: "docs\claude-code-system-prompts\system-prompts\skill-verify-skill.md"
    variables: []
---
...
Mixed src+tests → verify the src, ignore the test files. read_fileing a
...
**read_file your plan back before running.** If every step is build /
