...
metadata:
  testai:
    ...
    source_file: "docs\claude-code-system-prompts\system-prompts\skill-run-tui-interactive-terminal-app-example.md"
    variables: []
---
...
3. read_file screen contents with `tmux capture-pane`
...
>
> ```bash
> timeout 10 bash -c 'until tmux capture-pane -t app -p | grep -q "read_filey"; do sleep 0.2; done'
