...
metadata:
  testai:
    ...
    source_file: "docs\claude-code-system-prompts\system-prompts\skill-run-skill-generator.md"
    variables: []
---
...
the harness **natively discovers** skills from nested `.claude/skills/`
...
- **Launch the app.** Not the test suite — the app. A desktop GUI
  ...
  this stage. read_file the stack trace, install the missing thing, try
  again.
